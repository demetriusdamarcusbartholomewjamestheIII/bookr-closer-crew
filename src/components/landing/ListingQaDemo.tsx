...
const SCRIPT: TypewriterLine[] = [
  ...
  { role: "bookr", text: "1842 Oak St — let me get you in to see it. Are you pre-approved yet?" },
  { role: "lead", text: "Sí. ¿Cuántas recámaras tiene?" },
  {
    role: "bookr",
    text: "Los detalles se los repasa el agente en la visita — ¿jueves 2pm o viernes 10am?",
  },
];
