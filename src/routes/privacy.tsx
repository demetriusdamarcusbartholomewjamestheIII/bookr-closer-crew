...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Privacy Policy — Bookr" },
  ...
  return (
    <LegalPageShell>
      ...
      <p className="mt-6 leading-relaxed text-charcoal/75">
        This Privacy Policy describes how Bookr (&quot;Bookr,&quot; &quot;we,&quot; &quot;us,&quot;
        or &quot;our&quot;) collects, uses, discloses, and protects information when you visit{" "}
        ...
        whose information we process on a Client&apos;s behalf (&quot;Leads&quot; or &quot;End
        Users&quot;).
      </p>
      ...
      <div className="mt-12 space-y-10 text-charcoal/80">
        <Section title="1. Who we are">
          <p>
            ...
            proprietor. Our website is operated at heybookr.com. For privacy-related requests,
            contact us at{" "}
        ...
        <Section title="2. Information we collect">
          <p>
            Depending on how you interact with Bookr, we may collect the following categories of
            information:
          </p>
          <List
            items={[
        ...
        <Section title="5. Service providers and subprocessors">
          <p>
            We do not sell your personal information, and we do not share it with third parties for
            their own marketing or promotional purposes. To operate and deliver the service, we rely
            on a limited set of service providers and subprocessors who process information only on
            our behalf, under contract, and solely to provide the service to us. These include:
          </p>
          <List
            items={[
              "Infrastructure and hosting providers that store and transmit data securely on our behalf.",
              "Messaging, CRM, calendar, and automation platforms we use to operate the service (such as LeadConnector / GoHighLevel, Meta, Google, and telecommunications providers), which process data on our behalf to deliver the messages and bookings you request.",
              ...
              "Government authorities or regulators, only where required by valid legal process.",
            ]}
          />
          <p className="mt-4">
            We require these service providers to use information only for the purposes we specify
            and to protect it under appropriate contractual safeguards. They are not permitted to
          ...
          <p className="mt-4 font-semibold text-charcoal">
            ...
            information will not be shared with any third parties. Text messaging originator opt-in
            data and consent will not be shared with any third parties, except for the aggregators
            and telecommunications providers needed to deliver the messages you requested.
          </p>
        </Section>
        ...
        <Section title="12. International users">
          <p>
            ...
            other countries where our providers operate. Those countries may have data-protection
        ...
        <Section title="13. Changes to this policy">
          <p>
            ...
            the revised policy, except where additional consent is required by law.
          </p>
        </Section>
        ...
        <Section title="14. SMS text messaging and opt-in">
          <p>
            ...
            SMS text messages to individuals who voluntarily opt in on heybookr.com — for example,
            by submitting a demo request or contact form that includes a mobile number and a consent
          ...
          <p>
            ...
            through our website forms where you provide your mobile number and affirmatively agree
            to receive texts. Your consent is not a condition of purchasing any goods or services
            except where SMS is the channel you choose for the communications you request (such as
          ...
          <p className="mt-4">
            ...
            STOP to any message; you will receive a one-time confirmation and no further texts
            unless you opt in again. Reply HELP for assistance, email{" "}
            <a href={`mailto:${CONTACT_EMAIL}`} className={LEGAL_LINK_CLASS}>
              {CONTACT_EMAIL}
            </a>
            , or call{" "}
          ...
          <p className="mt-4">
            ...
            18 years old and the account holder or an authorized user of the mobile number you
            provide to opt in.
          </p>
          <p className="mt-4">
            For full terms governing our SMS program — including message types, frequency, and
            carrier limitations — see{" "}
            <a href="/terms" className={LEGAL_LINK_CLASS}>
