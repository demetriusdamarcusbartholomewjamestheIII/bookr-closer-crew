...
import { LEGAL_LINK_CLASS, LegalPageShell } from "@/components/LegalPageShell";
import { CONTACT_EMAIL, SITE_URL } from "@/lib/bookr-constants";
...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Terms of Service — Bookr" },
...
function TermsPage() {
  return (
    <LegalPageShell>
      <p className="text-xs font-semibold uppercase tracking-[0.2em] text-bookr-stripe-3">Legal</p>
      <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl">Terms of Service</h1>
      <p className="mt-3 text-sm text-charcoal/70">Last updated: {LAST_UPDATED}</p>
      <p className="mt-6 leading-relaxed text-charcoal/75">
        ...
        <a href="https://www.heybookr.com" className={LEGAL_LINK_CLASS}>
          heybookr.com
        </a>{" "}
      ...
      <p className="mt-4 leading-relaxed text-charcoal/75">
        Bookr is a brand name operated by Ian Nikel García Colotl, a sole proprietor
        (&quot;Bookr,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;).
      </p>
      ...
      <div className="mt-12 space-y-10 text-charcoal/80">
        ...
        <Section title="3. Eligibility and account responsibility">
          <p>
            ...
            authorized to bind any business entity on whose behalf you subscribe. You are
            responsible for maintaining accurate account information, safeguarding login
            credentials, and all activity occurring under your account.
          </p>
          <p className="mt-4">
        ...
        <Section title="5. Fees, billing, and payment">
          <p>
            Subscription fees are billed monthly in advance at the rates published on heybookr.com
            at the time you subscribe, unless otherwise agreed in writing during onboarding. All
          ...
          <p className="mt-4">
            We may change pricing upon at least 30 days&apos; notice. Price changes apply to the
            next billing cycle after notice. If you do not agree to a price change, you may cancel
        ...
        <Section title="6. Cancellation and refunds">
          ...
          <p className="mt-4">
            ...
            refunds for partial months. Upon cancellation, we will disconnect integrations and
        ...
        <Section title="7. Acceptable use and platform compliance">
          <p>
            You may not use the Service to transmit spam, phishing content, malware, or messages
            that infringe intellectual property or privacy rights. You may not attempt to reverse
            engineer, scrape, overload, or interfere with the Service or its security controls.
          </p>
          <p className="mt-4">
            Your use of Connected Platforms remains subject to each platform&apos;s terms and
            policies (including Meta, Google, telecommunications carriers, and CRM providers). You
            are responsible for maintaining compliant opt-in/consent practices for SMS and other
            regulated channels. Bookr may suspend or limit the Service if we reasonably believe your
            use poses legal, platform, or reputational risk.
          </p>
        </Section>
        ...
        <Section title="8. Intellectual property">
          <p>
            ...
            all related intellectual property, except for Content you provide. You retain ownership
            of your Content. You grant Bookr a non-exclusive license to use, host, copy, and process
            your Content solely to provide and improve the Service for you.
          </p>
          <p className="mt-4">
            You may not use Bookr trademarks without prior written permission. Feedback you provide
            may be used by Bookr without restriction or compensation.
          </p>
        </Section>
        ...
        <Section title="9. Confidentiality">
          <p>
            ...
            and to protect it with reasonable care. This obligation does not apply to information
            that is publicly available, independently developed, or lawfully received from a third
        ...
        <Section title="10. Disclaimers">
          ...
          <p className="mt-4">
            We do not guarantee that every Lead will respond, convert, or attend a booked
            appointment. Response times, booking rates, and conversation quality depend on Lead
            behavior, market conditions, your configuration, and third-party platform availability.
            You acknowledge that automated and human-assisted workflows may occasionally produce
            errors, delays, or misinterpretations despite reasonable safeguards.
          </p>
        </Section>
        ...
        <Section title="11. Limitation of liability">
          ...
          <p className="mt-4">
            ...
            $100). SOME JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS, SO THESE LIMITS MAY NOT
        ...
        <Section title="12. Indemnification">
          <p>
            You agree to defend, indemnify, and hold harmless Bookr from and against claims,
            damages, losses, and expenses (including reasonable attorneys&apos; fees) arising out of
            or related to: (a) your Content or Lead communications; (b) your breach of these Terms
            or applicable law; (c) your use of Connected Platforms; or (d) disputes between you and
            your Leads, brokers, or regulators, except to the extent caused by Bookr&apos;s gross
        ...
        <Section title="14. Governing law and disputes">
          <p>
            ...
            apply. Any dispute arising from these Terms or the Service will be brought in the state
            or federal courts located in Delaware, and each party consents to personal jurisdiction
            in those courts.
          </p>
          <p className="mt-4">
        ...
        <Section title="15. Changes to these Terms">
          <p>
            ...
            changes take effect no sooner than 30 days after posting unless required sooner by law
            or for security reasons. Continued use after the effective date constitutes acceptance.
          </p>
        </Section>
        ...
        <Section title="17. SMS messaging program">
          ...
          <p className="mt-4">
            ...
            as charged by your mobile carrier.
          </p>
          <p className="mt-4">
            <span className="font-semibold text-charcoal">Opt out at any time</span> by replying
            STOP to any message; you will receive a final confirmation and no further texts. Reply
            HELP for help, or contact us at{" "}
            <a href={`mailto:${CONTACT_EMAIL}`} className={LEGAL_LINK_CLASS}>
              {CONTACT_EMAIL}
            </a>
            .
          ...
          <p className="mt-4">
            ...
            18 years old and the account holder or an authorized user of the mobile number to opt
            in.
          </p>
          <p className="mt-4">
            For how we handle your information — including our commitment that mobile opt-in data
            and consent are never shared with third parties or affiliates for marketing — see our{" "}
            <a href="/privacy" className={LEGAL_LINK_CLASS}>
              Privacy Policy
            </a>
            .
          </p>
